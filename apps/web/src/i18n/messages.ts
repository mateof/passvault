...
export const gl = {
  ...
  'checkin.cameraDenied': 'Sen permiso para a cámara. Podes escribir o código a man aquí abaixo.',
  'checkin.cameraUnsupported':
    'Este navegador non dá acceso á cámara aquí. Fai falta unha conexión segura (https). Podes escribir o código a man.',
  'checkin.manual': 'Escribe o código',
  'checkin.check': 'Comprobar',
  'checkin.failed': 'Non se puido comprobar o código.',
  'checkin.admitted': 'Adiante. {seat}',
  'checkin.alreadyUsed': 'Xa entrou. {seat} pasou o {when}; van {count} veces.',
  'checkin.withdrawn': 'Esta entrada foi retirada polo organizador.',
  'checkin.unknown': 'Este código non é deste evento.',
  'checkin.used': 'Xa entrou',
  'checkin.usedTimes': 'presentada {count} veces',
  'checkin.markUsed': 'Marcar como entrada',
  'checkin.undo': 'Desfacer a entrada',
  'checkin.open': 'Abrir a porta',
...
export const es: Record<WebMessageKey, string> = {
  ...
  'checkin.cameraDenied':
    'Sin permiso para la cámara. Puedes escribir el código a mano aquí abajo.',
  'checkin.cameraUnsupported':
    'Este navegador no da acceso a la cámara aquí. Hace falta una conexión segura (https). Puedes escribir el código a mano.',
  'checkin.manual': 'Escribe el código',
  'checkin.check': 'Comprobar',
  'checkin.failed': 'No se ha podido comprobar el código.',
  'checkin.admitted': 'Adelante. {seat}',
  'checkin.alreadyUsed': 'Ya ha entrado. {seat} pasó el {when}; van {count} veces.',
  'checkin.withdrawn': 'Esta entrada fue retirada por el organizador.',
  'checkin.unknown': 'Este código no es de este evento.',
  'checkin.used': 'Ya ha entrado',
  'checkin.usedTimes': 'presentada {count} veces',
  'checkin.markUsed': 'Marcar como entrada',
  'checkin.undo': 'Deshacer la entrada',
  'checkin.open': 'Abrir la puerta',
...
export const en: Record<WebMessageKey, string> = {
  ...
  'checkin.cameraDenied': 'No permission for the camera. You can type the code in below.',
  'checkin.cameraUnsupported':
    'This browser gives no camera access here. It needs a secure connection (https). You can type the code in instead.',
  'checkin.manual': 'Type the code',
  'checkin.check': 'Check',
  'checkin.failed': 'The code could not be checked.',
  'checkin.admitted': 'Go ahead. {seat}',
  'checkin.alreadyUsed': 'Already in. {seat} went through at {when}; that is {count} times now.',
  'checkin.withdrawn': 'The organiser withdrew this ticket.',
  'checkin.unknown': 'This code is not from this event.',
  'checkin.used': 'Already in',
  'checkin.usedTimes': 'presented {count} times',
  'checkin.markUsed': 'Mark as admitted',
  'checkin.undo': 'Undo the admission',
  'checkin.open': 'Open the door',
